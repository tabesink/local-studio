...
| BR-007 LightRAG proof | F-005 | AI-001 | pinned fixture | implemented for F-005 with vendored LightRAG 1.4.16 proof |
| BR-008 exact evidence mapping | F-006, F-007 | AI-001 | mapper/foreign/deleted tests | implemented for F-006 via strict parser, app-boundary retrieval proof, mapper discard matrix, and safe DTO tests; F-007 citation use planned |
| BR-009 server-classified direct chat and agentic RAG | F-007 | API-001, EVT-001, AI-001, DATA-001 | SSE + intent/orchestrator validation tests | planned |

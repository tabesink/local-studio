---
id: F-005
title: LightRAG Indexing And Query Eligibility UX And State Contract
status: approved
...
# F-005 - UX And State Contract

## Surface

Admin API extends source status and retry/cancel affordances. Frontend must show backend state only and never poll LightRAG directly.

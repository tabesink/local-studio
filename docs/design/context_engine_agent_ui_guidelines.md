# Context Engine Agent UI Guidelines — Local Studio Visual Parity

> **Status:** Agent-facing implementation guide copied from the Local Studio visual-parity spec.  
...
| Need | Document |
| --- | --- |
| Canonical UI design system | `DESIGN.md` |
...
2. `DESIGN.md`;
3. this agent-facing guide;
4. feature-specific UI requirements;
5. generic shadcn/Tailwind defaults.

Keep this file aligned with `DESIGN.md` when visual rules, reusable UI patterns, or acceptance checks change.

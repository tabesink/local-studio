...
Source: `.devnotes/P4-post-impl-REVIEW/F-005-P5-readiness.md`
...
Start at [[ID-A LightRAG Indexing Contract]] for contract blockers and slice notes.
...
Important: live Docling/Reducto SDK calls are not a P4 closure gap. They are a pilot-prep gap — see [[ID-A Live Parser SDK Followup]].

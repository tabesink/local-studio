---
id: F-008-TEST
title: Admin Document Readiness and Operations Surface test plan
status: proposed
...
- Member direct route/API access rejected.
- Admin sees ready/processing/failed/deleting variants.
- Polling stops at terminal state.
- Admin upload operation does not block a member chat UI.
